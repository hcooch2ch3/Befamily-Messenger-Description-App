...
// MARK: - AppStorePreviews
struct AppStorePreviews: Codable {
    let resultCount: Int
    let results: [Result]
}
...
struct Result: Codable {
    ...
    let features, advisories: [JSONAny]
    ...
    let kind, releaseNotes, resultDescription: String
    ...
    enum CodingKeys: String, CodingKey {
        case isGameCenterEnabled, features, advisories, supportedDevices, screenshotUrls, ipadScreenshotUrls, artworkUrl60, artworkUrl512, artworkUrl100
        case artistViewURL = "artistViewUrl"
        case appletvScreenshotUrls, kind, releaseNotes
        ...
        case trackName, currentVersionReleaseDate, currency
